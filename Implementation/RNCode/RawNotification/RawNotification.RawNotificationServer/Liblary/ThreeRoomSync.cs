...
namespace RawNotification.RawNotificationServer.Liblary
{
    /// <summary>
    /// Một class cho phép truy cập tài nguyên một cách đồng bộ.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    internal class ThreeRoomSync<T>
    {
        ...
        internal ThreeRoomSync(Func<T> refreshResourceMethod, T defaultResourceValue)
        {
            Resource = defaultResourceValue;
            RefreshResourceMethod = refreshResourceMethod;
        }

        internal T RefreshResourceSync()
        {
