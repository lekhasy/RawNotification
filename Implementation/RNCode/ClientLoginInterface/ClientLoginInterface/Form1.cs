...
namespace ClientLoginInterface
{
    public partial class Form1 : Form
    {
        ...
        RawNotification.SharedLiblary.MyBitConverter<FromClientPacket> _FromClientConverter = new RawNotification.SharedLiblary.MyBitConverter<FromClientPacket>();
        RawNotification.SharedLiblary.MyBitConverter<FromServerPacket> _FromServerConverter = new RawNotification.SharedLiblary.MyBitConverter<FromServerPacket>();
        public Form1()
        {
            InitializeComponent();
