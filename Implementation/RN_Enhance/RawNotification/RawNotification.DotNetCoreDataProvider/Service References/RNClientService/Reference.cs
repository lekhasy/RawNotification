...
namespace RawNotification.DotNetCoreDataProviders.RNClientService {
    ...
    public interface IRNClientCommunicator {
        ...
        System.Threading.Tasks.Task<RawNotification.Models.BaseServiceResult<long, string>> AddDeviceAsync(long ReceiverId, RawNotification.Models.DBModels.Device deviceInfo, string LoginToken);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRNClientCommunicator/UpdateDeviceInfo", ReplyAction="http://tempuri.org/IRNClientCommunicator/UpdateDeviceInfoResponse")]
        System.Threading.Tasks.Task<RawNotification.Models.BaseServiceResult<long, string>> UpdateDeviceInfoAsync(RawNotification.Models.DBModels.Device deviceInfo, string DeviceIMEI, string DeviceToken);
        ...
        System.Threading.Tasks.Task<RawNotification.Models.BaseServiceResult<byte[]>> GetNotificationContentAsync(long NotificationId, string NotificationAccessKey, string DeviceToken, string DeviceIMEI);
        ...
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(RawNotification.Models.BaseServiceResult<long>))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(RawNotification.Models.BaseServiceResult<long, string>))]
        System.Threading.Tasks.Task<RawNotification.Models.BaseServiceResult> RemoveDeviceAsync(string DeviceIMEI, string DeviceToken);
    }
    ...
    public partial class RNClientCommunicatorClient : System.ServiceModel.ClientBase<RawNotification.DotNetCoreDataProviders.RNClientService.IRNClientCommunicator>, RawNotification.DotNetCoreDataProviders.RNClientService.IRNClientCommunicator {
        ...
        public System.Threading.Tasks.Task<RawNotification.Models.BaseServiceResult<long, string>> AddDeviceAsync(long ReceiverId, RawNotification.Models.DBModels.Device deviceInfo, string LoginToken) {
            return base.Channel.AddDeviceAsync(ReceiverId, deviceInfo, LoginToken);
        }
        
        public System.Threading.Tasks.Task<RawNotification.Models.BaseServiceResult<long, string>> UpdateDeviceInfoAsync(RawNotification.Models.DBModels.Device deviceInfo, string DeviceIMEI, string DeviceToken) {
            return base.Channel.UpdateDeviceInfoAsync(deviceInfo, DeviceIMEI, DeviceToken);
        }
        
        public System.Threading.Tasks.Task<RawNotification.Models.BaseServiceResult<byte[]>> GetNotificationContentAsync(long NotificationId, string NotificationAccessKey, string DeviceToken, string DeviceIMEI) {
            return base.Channel.GetNotificationContentAsync(NotificationId, NotificationAccessKey, DeviceToken, DeviceIMEI);
        }
        ...
        public System.Threading.Tasks.Task<RawNotification.Models.BaseServiceResult> RemoveDeviceAsync(string DeviceIMEI, string DeviceToken) {
            return base.Channel.RemoveDeviceAsync(DeviceIMEI, DeviceToken);
        }
